...
function ConfirmEmailFunc() {
    ...
    return (
        ...
        <PublicPageContainer>
            <div className="lg:max-w-4xl mr-auto ml-auto p-6 lg:border lg:borfder-[#ccc] my-12 flex flex-col items-center">
                <img src="https://bucket-qlrc5d.s3.eu-west-2.amazonaws.com/assets/paper_16259254.png" />
