        ...
        <div className='flex'>
            ...
            <div className='w-full lg:w-[50%] py-12 px-[12%]'>
                ...
                <div className='flex justify-end gap-2 flex-col lg:flex-row mt-6 lg:mt-0'>
                    <a href="/" className=' inline-flex justify-center items-center py-3 px-6 bg-transparent border-2 border-black rounded-full text-black lg:my-6' onClick={(e) => { e.preventDefault(); setStep(4) }}>Omitir esta pregunta</a>
