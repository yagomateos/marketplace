...
export default function StoreSetupSteps({storeStep , setStoreStep}) {
        ...
        <div className='store-setup-header-wrapper flex justify-center w-full p-5'>
            <div className='store-setup-header-inner w-full lg:max-w-7xl'>
                <ul className='store-setup-heading-list flex justify-center'>
                    <li className='w-1/6'>
                        <a className='flex flex-col items-center' onClick={e=>{e.preventDefault(); setStoreStep(0)}}>
                    ...
                    <li className='w-1/6 before-enabled relative'>
                        <a className='flex flex-col items-center' onClick={e=>{e.preventDefault(); setStoreStep(1)}}>
                    ...
                    <li className='w-1/6 before-enabled relative'>
                        <a className='flex flex-col items-center' onClick={e=>{e.preventDefault(); setStoreStep(2)}}>
                    ...
                    <li className='w-1/6 before-enabled relative'>
                        <a className='flex flex-col items-center' onClick={e=>{e.preventDefault(); setStoreStep(3)}}>
                    ...
                    <li className='w-1/6 before-enabled relative'>
                        <a className='flex flex-col items-center' onClick={e=>{e.preventDefault(); setStoreStep(4)}}>
