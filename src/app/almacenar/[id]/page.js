...
import StoreTabs from './sections/store-tabs'
            ...
            return (
                <>
                    <div className='store-wrapper '>
                        {/* banner */}
                        <div className='store-banner h-[160px] lg:h-[380px]'>
                        ...
                        <div className='bg-[#f8f8f8]'>
                            <div className='lg:flex justify-between max-w-7xl mr-auto ml-auto py-5 '>
                                {/* first column */}
                                <div className='first-col'>
                                    <div className='lg:flex lg:gap-4'>
                                        <img className='h-[100px] w-[100px] mt-[-50px] lg:mt-[0] mr-auto ml-auto lg:ml-0 lg:h-[150px] lg:w-[150px] object-cover rounded-md' src={storeInfo[0]?.logo ? storeInfo[0].logo : 'https://bucket-qlrc5d.s3.eu-west-2.amazonaws.com/assets/placeholder-image.jpg'} />
                                        <div className='p-4 flex justify-center flex-col text-center lg:text-left'>
                                ...
                                <div className='flex items-center'>
                                    <p className='text-sm hidden lg:block'><img className='w-5 inline-block' src="https://bucket-qlrc5d.s3.eu-west-2.amazonaws.com/assets/reviews.svg" /> Buenas reseñas La valoración media de las reseñas es 4,8 o más alta</p>
                                </div>
                                {/* third column */}
