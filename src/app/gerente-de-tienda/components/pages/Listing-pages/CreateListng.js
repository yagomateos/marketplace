...
export default function CreateListng({
  ...
  const addMaterialsFunc = (e) => {
    ...
    currentMat &&
      materials.indexOf(currentMat) === -1 &&
      setmaterials([...materials, currentMat]);
    e.target.previousElementSibling.value = "";
  };
  ...
  const popupSubmit = (e) => {
    ...
    if (productType && productVendor && whatProduct && productAge) {
      ...
      try {
        ...
        if (Listings) {
          Listings.forEach((listing) => {
            // Check if there's already an object with the same sId
            if (!AllStIds.some((item) => item.sId === listing.s_id)) {
              AllStIds.push({ stName: listing.store_name, sId: listing.s_id });
            }
          });
        }

        console.log(AllStIds);
        setAllStores(AllStIds);
    ...
    <div className="w-full relative">
      ...
      {createPopup && (
        <div className="fixed w-full h-full min-h-screen bg-[#00000061] left-0 top-0 z-10 flex justify-center items-center">
          <div className="w-full lg:w-[40%] bg-white rounded-lg p-6">
            ...
            <p>
              Esta información básica nos ayuda a comprender sus listados y cómo
              cumplen con nuestras políticas.
            </p>
            <ProductFormFirst
            ...
            {popupErr && (
              <div className="text-green-700 text-sm">{popupErr}</div>
            )}
          </div>
        </div>
      )}
      ...
      <div>
        <div className="mb-6 p-3">
          ...
          <h2 className="mt-3 text-lg lg:text-3xl leading-tight font-semibold">
            Nuevo listado
          </h2>
        </div>

        <div
          className={`w-full kd-fixed-nav-list ${
            isSticky ? "fixed top-0 bg-white z-30" : ""
          }`}
        >
          <ul className="flex w-full flex-col lg:flex-row border-b border-[#ccc] lg:px-0 ">
            <li>
              <a
                className={`py-2 w-[100%] block px-3 border-b-0 cursor-pointer font-semibold`}
                href="#about-box"
              >
                Acerca de
              </a>
            ...
            <li>
              <a
                className={`py-2 w-[100%] block px-3 border-b-0 cursor-pointer lg:border-l-0 font-semibold`}
                href="#price-box"
              >
                Variaciones
              </a>
        ...
        <div className="p-0 lg:p-5">
          ...
          <div
            id="about-box"
            className="w-full p-3 lg:p-6 bg-white border border-[#c5c5c5] rounded-2xl"
          >
            ...
            <div>
              ...
              <p className="text-sm mb-3">
                Incluye palabras clave que los compradores usarían para
                encontrar este artículo
              </p>
              <input
                onChange={(e) => setProdTitle(e.target.value)}
                className="w-full p-4 rounded-lg border border-[#f2f2f2]"
              />
            </div>

            <div className="mt-3">
              <p className="text-lg">
                Fotos y vídeo <span className="text-red-700">*</span>
              </p>
              <p className="text-sm mb-3">
                Añade hasta 7 fotos. (Se recomiendan 980 px x 1180 px)
              </p>
          ...
          <div
            id="price-box"
            className="bg-white rounded-2xl p-3 lg:p-6 mt-6 border border-[#c5c5c5] w-ful"
          >
            <h3 className="text-xl font-semibold ">Precio e inventario</h3>
            <p className="mb-3 text-sm">
              Fija un precio e indica el número de unidades disponible.
            </p>
            ...
            <div className="relative mt-4">
              ...
              <input
                ...
                className="lg:w-50 w-full p-3 border border-[#ccc] rounded-lg"
              />
              <span className="absolute left[50%] translate-x-[-120%] top-[50%] ">
                EUR
              </span>
            </div>
          ...
          <div
            id="details-box"
            className="bg-white rounded-2xl p-3 lg:p-6 mt-6 border border-[#c5c5c5]"
          >
            <h3 className="text-xl font-semibold ">Detalles</h3>
            <p className="mb-3 text-sm">
              Comparta algunos detalles más de su artículo para que sea más
              fácil encontrarlo en la búsqueda y ayude a los compradores a saber
              qué esperar.
            </p>
            ...
            <div className="lg:flex gap-4 flex-wrap mb-6 mt-6 relative">
              ...
              <p className="text-sm mb-3">
                ¿Qué hace que tu artículo sea especial? Los compradores solo
                verán las primeras líneas a menos que expandan la descripción.
              </p>
              <textarea
                className="border border-{#ccc] w-full rounded-lg"
                rows="6"
            ...
            <div className="lg:flex gap-4 flex-wrap mb-6 mt-6 relative">
              ...
              <input
                ...
                onKeyUp={(e) => searchCategories(e)}
                className="border border-[#ccc] w-full p-3 rounded-full bg-transparent"
                placeholder="Busca una categoría. Por ejemplo: Sombreros, Anillos, Cojines, etc."
              />
                  ...
                  <ul>
                    {categories.map((cat, key) => (
                      <li
                        ...
                        key={key}
                        onClick={(e) => {
                          setValueWithPopup(cat.id, cat.category_name);
                        }}
                      >
                        {cat.category_name}
                      </li>
            ...
            <div className="mt-6">
              ...
              <div className="mt-5">
                ...
                <select
                  ...
                  className="w-full p-4 border border-[#ccc] rounded-lg"
                >
              ...
              <div className="mt-5">
                ...
                <select
                  onChange={(e) => setseconcolor(e.target.value)}
                  className="w-full p-4 border border-[#ccc] rounded-lg"
                >
                  <option value="">seleccionar…</option>
                  <option>Negro</option>
              ...
              <div className="mt-5">
                ...
                <select
                  onChange={(e) => setfestivity(e.target.value)}
                  className="w-full p-4 border border-[#ccc] rounded-lg"
                >
                  <option value="">seleccionar…</option>
                  ...
                  <option value="Día de la Independenci">
                  ...
                  <option value="Día de San Patricio">
                    Día de San Patricio
                  </option>
              ...
              <div className="mt-12">
                ...
                <p className="text-sm">
                  Añade hasta 13 etiquetas para ayudar a las personas que buscan
                  tus artículos.
                </p>
                <div>
                  <input
                    onChange={(e) => setCurrentTag(e.target.value)}
                    className="p-3 border border-[#ccc] inline-block mr-3 lg:mr-8 mt-5 rounded-lg w-2/3 lg:w-3/5"
                    placeholder="Forma, color, estilo, función, etc."
                  />
                  <a
                ...
                <div className="flex flex-row flex-wrap mt-3">
                  {tags &&
                    tags.map((tag, key) => (
                      ...
                      >
                        {tag}
                        <span className="absolute right-[50x] top-[5px] text-xs">
                          X
                        </span>
                      </div>
                    ))}
              ...
              <div className="mt-12">
                ...
                <p className="text-sm">
                  Los compradores valoran la transparencia: explícales que has
                  usado para crear tu producto.
                </p>
                <div>
                  <input
                    onChange={(e) => setCurrentMat(e.target.value)}
                    className="p-3 border border-[#ccc] inline-block mr-3 lg:mr-8 mt-5 rounded-lg w-2/3 lg:w-3/5"
                    placeholder="Forma, color, estilo, función, etc."
                  />
                  <a
        ...
        <div className="mt-3">
          {productSuccess && (
            <div className="text-sm text-green-800">{productSuccess}</div>
          )}
        </div>
      </div>
    </div>
