...
export default function Dashboard({ storeDta, userData, setSettingsPage }) {
  ...
  const isLoading = !listings || !stores;
            ...
            <div>
              {userData && stores && (
                <a
                  ...
                  href={`https://www.vendalia.es/tiendas/${stores && stores.id}`}
                >
                  {`vendalia.es/tiendas/${stores && stores.id}`}
                </a>
              )}
            </div>
          </div>
            ...
            {listings ?
                    ...
                    {listings.map((listing, key) => (
                      <div key={key} className="w-[46%]">
                        <a href={`/listado?pid=${listing.id}`}>
                          <img
                            className="w-[140px] h-[140px] object-cover max-w-full"
              ...
              (
                <div className="w-full p-4 text-lg text-center">
                  ...
                  />
                  <p>No se encontraron listados!</p>
                </div>
              )}
          </div>
