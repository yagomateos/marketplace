    ...
    <div className='max-w-5xl'>
      <div>
        <ul className='flex border-b mb-6 border-[#ccc] px-6'>
          <li><a className={`py-2 border border-[#ccc] block px-3 border-b-0 cursor-pointer ${selectedTab === 1 && 'bg-[#f2f2f2]'}`} onClick={() => setSelectedTab(1)}>Opciones</a></li>
          <li><a className={`py-2 border border-[#ccc] block px-3 border-b-0 cursor-pointer ${selectedTab === 2 && 'bg-[#f2f2f2]'}`} onClick={() => setSelectedTab(2)}>Modo Vacaciones</a></li>
          <li><a className={`py-2 border border-[#ccc] block px-3 border-b-0 cursor-pointer ${selectedTab === 3 && 'bg-[#f2f2f2]'}`} onClick={() => setSelectedTab(3)}>Análisis Web</a></li>
          <li><a className={`py-2 border border-[#ccc] block px-3 border-b-0 cursor-pointer ${selectedTab === 4 && 'bg-[#f2f2f2]'}`} onClick={() => setSelectedTab(4)}>Descargar Datos</a></li>
          <li><a className={`py-2 border border-[#ccc] block px-3 border-b-0 cursor-pointer ${selectedTab === 5 && 'bg-[#f2f2f2]'}`} onClick={() => setSelectedTab(5)}>Cerrar Tienda</a></li>
        </ul>
      </div>
      ...
      {selectedTab === 1 && (
        <div>
          <h2 className='text-2xl font-semibold mb-4'>Opciones de la Tienda</h2>
      ...
      {selectedTab === 2 && (
        <div>
          <h2 className='text-2xl font-semibold mb-4'>Modo Vacaciones</h2>
      ...
      {selectedTab === 3 && (
        <div>
          <h2 className='text-2xl font-semibold mb-4'>Análisis Web Potenciado por Google Analytics</h2>
      ...
      {selectedTab === 4 && (
        <div>
          <h2 className='text-2xl font-semibold mb-4'>Descargar Datos de la Tienda</h2>
      ...
      {selectedTab === 5 && (
        <div>
          <h2 className='text-2xl font-semibold mb-4'>Cerrar Tienda</h2>
