...
export default function Featuredcategories({ featuredCategories }) {
    ...
    return (
        <div className='absolute w-3/4 py-6 bg-white drop-shadow-md shadow-slate-600 z-50 left-0 top-20 rounded-lg kd-nav-popup-wrapper'>
             <div className="caret-icon absolute top-0 left-1/3 transform -translate-x-1/2 -translate-y-1/2">
             <span className="caret-icon-icon"></span>
            </div>
            <div className="flex justify-between">
                <ul className="w-2/5 h-full overflow-y-scroll overflow-x-hidden scrollbar-thin">
