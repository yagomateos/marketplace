            ...
            <div className="max-w-4xl container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mt-24">
                <div>
                    ...
                    <ul className={`text-sm leading-loose ${openMenu == 'gtk' ? '' : 'hidden'} lg:block`}>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">About Us</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">News & Blog</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Careers</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Investors</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Contact Us</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className={`text-sm leading-loose ${openMenu == 'cs' ? '' : 'hidden'} lg:block`}>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Help Center</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">FAQ&apos;s</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Accessibility</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Feedback</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Size Guide</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Payment Method</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className={`text-sm leading-loose ${openMenu == 'or' ? '' : 'hidden'} lg:block`}>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Track Order</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Shipping & Delivery</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Return & Exchange</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Price Match Guarantee</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className={`text-sm leading-loose ${openMenu == 'ql' ? '' : 'hidden'} lg:block`}>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Privacy Policy</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Terms of Use</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Legal</a></li>
                        <li><a href="#" className="text-gray-800 hover:text-gray-800 p-2 block">Site Map</a></li>
                    </ul>
                </div>
            </div>
